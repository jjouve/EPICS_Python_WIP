...
%typemap(python,out) PyObject *captrcast,
                     PyObject *captrvalue,
                     PyObject *captrcreate,
                     PyObject *captrset,
                     PyObject *captradd,
                     PyObject *captrfree  
{
...
%typemap(python,ret) int captrset {
  if ($source == -1) return NULL;
}

PyObject *captrcast(PyObject *ptr, char *type); 
...
PyObject *captrvalue(PyObject *ptr, int index = 0, char *type = 0);
...
PyObject *captrset(PyObject *ptr, PyObject *value, int index = 0, char *type = 0);
...
PyObject *captrcreate(char *type, PyObject *value = 0, int nitems = 1);
...
PyObject *captrfree(PyObject *ptr);
...
PyObject *captradd(PyObject *ptr, int offset);
...
void      captrmap(char *type1, char *type2);
